<template>
  <div class="sm:px-6 w-full">
    ...
    <div class="bg-white py-4 md:py-7 px-4 md:px-8 xl:px-10">
      <div class="sm:flex items-center justify-end mb-10 gap-5">
        <a
          href="/register"
          class="inline-block rounded bg-blue-500 px-7 pb-2.5 pt-3 text-sm font-semibold uppercase leading-normal text-white"
          >Create new Role</a
        >
        <a
          href="/register"
          class="inline-block rounded bg-green-500 px-7 pb-2.5 pt-3 text-sm font-semibold uppercase leading-normal text-white"
          >Create New User</a
        >
        <button
