    ...
    <div class="bg-white py-4 md:py-7 px-4 md:px-8 xl:px-10">
      <div class="sm:flex items-center justify-end mb-10 gap-5">
        <RouterLink
          ...
          class="focus:ring-2 focus:ring-offset-2 text-white focus:ring-green-600 mt-4 sm:mt-0 inline-flex items-center justify-around gap-2 px-6 py-2.5 bg-green-600 hover:bg-amber-600 focus:outline-none rounded"
          >New Department</RouterLink
        >
        <button
