...
<template>
  <div class="w-[70%] mx-auto mt-5 flex flex-col">
    <div class="p-10 mt-10 w-[100%] grid grid-cols-3 gap-12">
      <div v-for="product in products" v-bind:key="product.id">
        ...
        >
          ...
          <div class="flex flex-col gap-4 mt-2">
            ...
            <div class="flex justify-around items-center bg-slate-100 rounded-xl py-2">
              <button
                @click="editProducts(product.id)"
                title="Edit"
                class="card-button flex justify-center items-center hover:bg-indigo-200 group cursor-pointer rounded-full active:scale-100 duration-200 w-[2.5rem] h-[2.5rem]"
              >
                <svg
